...
RageAAcheckbox:SetDescription("Turns on Rage AA, overrides Legit AA")
local FreestandRageCheckbox = gui.Checkbox(group, "freestand_rage_aa", "Freestanding", false)
FreestandRageCheckbox:SetDescription("Hides your real head behind the wall and peeks the fake")
local JitterRageCheckbox = gui.Checkbox(group, "jitter_rage_aa", "Jitter", false)
JitterRageCheckbox:SetDescription("Jitters your head from side to side")
local LowDeltaCheckbox = gui.Checkbox(group, "low_delta", "Low Delta", false)
LowDeltaCheckbox:SetDescription("Users low desync rotation")
local HalfDeltaCheckbox = gui.Checkbox(group, "half_delta", "Half Delta", false)
HalfDeltaCheckbox:SetDescription("Uses half desync rotation of max")
local LogicCheckbox = gui.Checkbox(group, "logic", "hubertAA (overrides all other settings)", false)
LogicCheckbox:SetDescription("Uses my custom AA to prevent your head from being hit")
local LogicInverterCheckbox = gui.Checkbox(group, "logic_inverter", "hubertAA Invert", false)
LogicInverterCheckbox:SetDescription("Inverts the side of hubertAA only")
...
LegitAAcheckbox:SetDescription("Turns on Legit AA")
local LegitAAonEcheckbox = gui.Checkbox(group2, "legit_aa_on_e", "Legit AA on Use only", false)
LegitAAonEcheckbox:SetDescription("Only Legit AAs when the use key is being held")
local FreestandCheckbox = gui.Checkbox(group2, "freestand_legit_aa", "Freestanding", false)
FreestandCheckbox:SetDescription("Hides your real head behind the wall and peeks the fake")
local JitterCheckbox = gui.Checkbox(group2, "jitter_legit_aa", "Jitter", false)
JitterCheckbox:SetDescription("Jitters your head from side to side")
local SafeLegitAAcheckbox = gui.Checkbox(group2, "safe_legit_aa", "MM mode (no flicking)", false)
SafeLegitAAcheckbox:SetDescription("Uses micromovement desync type to prevent flicking")
local LogicLegitCheckbox = gui.Checkbox(group2, "logic_legit", "hubertAA Legit", false)
LogicLegitCheckbox:SetDescription("Turns on hubertAA for LegitAA")
local LogicLegitInverterCheckbox = gui.Checkbox(group2, "logic_legit_inverter", "hubertAA Legit Invert", false)
LogicLegitInverterCheckbox:SetDescription("Inverts the side of hubertAA only")

local group3 = gui.Groupbox(path, "Manual Settings", 16,456,296,100)
local ManualLeftCheckbox = gui.Checkbox(group3, "manual_left", "Manual Left", false)
ManualLeftCheckbox:SetDescription("Puts your head to the left side")
local ManualRightCheckbox = gui.Checkbox(group3, "manual_right", "Manual Right", false)
ManualRightCheckbox:SetDescription("Puts your head to the right side")
...
IndicatorsCheckbox:SetDescription("Shows what your settings for some features are")
local InvertIndicatorCheckbox = gui.Checkbox(group4, "invert_indicator", "Invert Indicator", false)
InvertIndicatorCheckbox:SetDescription("Shows what side your head is on")
local WatermarkCheckbox = gui.Checkbox(group4, "watermark", "Watermark", false)
WatermarkCheckbox:SetDescription("Draws a watermark for the cheat/lua")
local AspectRatioSlider = gui.Slider(group4, "aspect_ratio", "AspectRatio", 0, 0, 200)
...
BuybotCheckbox:SetDescription("Buys Stuff in the beginning of the round")
local BuybotCombo = gui.Combobox(group5, "buybot_items", "Buybot Main","None", "Auto", "Scout", "AWP")
BuybotCombo:SetDescription("Choose what primary weapon to buy")
local Buybot2Combo = gui.Combobox(group5, "buybot2_items", "Buybot Secondary", "None", "Heavy Pistol", "Dual Barettas", "Tec9/FiveSeven")
Buybot2Combo:SetDescription("Choose what secondary weapon to buy")
local Buybot3Checkbox1 = gui.Checkbox(group5, "buybot3_nades", "Buy Nades", false)
Buybot3Checkbox1:SetDescription("Buys grenades")
local Buybot3Checkbox2 = gui.Checkbox(group5, "buybot3_armor", "Buy Armor", false)
Buybot3Checkbox2:SetDescription("Buys armor")
local Buybot3Checkbox3 = gui.Checkbox(group5, "buybot3_zeus", "Buy Zeus", false)
